...
module.exports = function (context) {
    ...
    var wxPayEntryActivitySourcDir = getAbsPath('android', '/src/com/tronclass/x5/v3/wxapi/');
    ...
    if(context.hook == "after_plugin_install"){
        replace(wxPayEntryActivityPath, 'package com.tronclass.x5.v3.wxapi;', "package " + packageName + ".wxapi;");
